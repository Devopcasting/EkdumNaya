...
class IdentifyAadhaarDocument:
    def __init__(self, text_list: list, logger: object) -> None:
        ...
        self.targets = [
            r"\b(uidal.gov.in|male|female|mame|FEMALI|femala|femate|eemale|government of india|UniqualidentificationsAuthority|MERA AADHAAR  MERI PEHGHAN|Unique identification Authority oF india|wwwuldal.cowin|ATHORITROR|vidal|gov.in|Aadhaar-Aam Admi ka Adhikar|autiority of india|authority-of|www.uldal.gov.in)\b"
        ]
